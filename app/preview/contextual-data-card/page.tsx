    ...
    <main className="min-h-screen bg-zinc-100 px-5 py-12 text-zinc-950">
      <div className="mx-auto max-w-[1040px]">
        <div className="mb-8">
          ...
          <p className="mt-3 max-w-2xl text-lg leading-7 text-zinc-600">Branch-only preview of the reusable player snapshot treatment. The production component is data-driven and only renders evidence-backed rows and rights-approved local imagery.</p>
        </div>

        <div className="grid items-start gap-10 rounded-[32px] bg-white p-6 shadow-sm md:p-10 lg:grid-cols-[minmax(0,1fr)_300px]">
          <article className="space-y-6">
            ...
            <p className="text-xl leading-9 text-zinc-700">The player portrait gives the card an immediate human focal point, while the verified career facts make it useful rather than decorative.</p>
          </article>
          ...
          <div className="lg:sticky lg:top-8">
            <ContextualDataCard card={{
              ...
              imageUrl: "https://commons.wikimedia.org/wiki/Special:Redirect/file/Joey_Carbery_2021.jpg",
              imageAlt: "Joey Carbery playing rugby",
              rows: [
              ...
              note: "Production cards will use a rights-approved local Sanity portrait where available; uncertain or unavailable imagery is omitted.",
            }} />
          </div>
        </div>
      </div>
