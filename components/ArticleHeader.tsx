  ...
  return (
    <header className="border-b border-zinc-200 bg-zinc-50">
      <div className="mx-auto max-w-6xl px-5 py-10 md:px-6 md:py-14">
        <nav aria-label="Breadcrumb" className="mb-6 text-sm font-bold text-zinc-500">
        ...
        <h1 className="max-w-5xl text-4xl font-black leading-[0.98] tracking-tight text-zinc-950 md:text-6xl">
          {title}
        </h1>

        <p className="mt-5 max-w-4xl text-lg leading-8 text-zinc-600 md:text-xl">
          {subtitle}
        </p>
