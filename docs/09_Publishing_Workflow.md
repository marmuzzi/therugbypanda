...
6. Check available connectors before asking the user to configure anything.
...
4. Deploy only when code changes require deployment.
5. Run Validate Live Site.
6. Verify production manually when the change affects visible UI or public routes.
