...
export const editorialImageType = defineType({
  ...
  fields: [
    ...
    defineField({ name: "suggestedUse", title: "Suggested use", type: "array", group: "editorial", of: [defineArrayMember({ type: "string" })], options: { list: suggestedUseOptions } }),
    defineField({ name: "team", title: "Team / squad", type: "string", group: "editorial", description: "Primary professional team or national squad pictured, when identifiable from source metadata." }),
    defineField({ name: "people", title: "Players / coaches pictured", type: "array", group: "editorial", of: [defineArrayMember({ type: "string" })], description: "Named players or coaches identifiable from the source title, caption or metadata." }),
    defineField({ name: "competitionEvent", title: "Competition / event", type: "string", group: "editorial" }),
    defineField({ name: "eventDate", title: "Event date", type: "date", group: "editorial", description: "Event/photo date only when it can be inferred reliably from source metadata." }),
    ...
    defineField({ name: "sourceUrl", title: "Source / landing-page URL", type: "url", group: "rights" }),
    defineField({ name: "sourcePageTitle", title: "Source page title", type: "string", group: "rights" }),
    defineField({ name: "creatorUrl", title: "Creator / photographer URL", type: "url", group: "rights" }),
    ...
    defineField({ name: "acquisitionScope", title: "Acquisition scope", type: "string", group: "metadata", readOnly: true }),
    defineField({ name: "acquisitionQuery", title: "Acquisition query", type: "string", group: "metadata", readOnly: true }),
    defineField({ name: "sourceIndexedAt", title: "Source indexed at", type: "datetime", group: "metadata", readOnly: true }),
    defineField({ name: "sourceProvider", title: "Source provider", type: "string", group: "metadata", readOnly: true }),
