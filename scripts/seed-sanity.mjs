...
const introductionDraft = {
  ...
  body: [
    block("If you're reading this, there's a good chance you love rugby as much as we do."),
    block("Not because every match is perfect."),
    block("Quite the opposite."),
    block("We love the Monday morning debates after a European weekend."),
    block("We love spotting the next academy player before everyone knows their name."),
    block("We love the tactical battles that never make the highlights."),
    block("And yes... we occasionally think the referee got it wrong too."),
    block("Rugby has never lacked people telling us what happened."),
    block("What we've always wanted is someone to explain why."),
    block("Why a selection mattered."),
    block("Why momentum shifted."),
    block("Why one decision changed an entire match."),
    block("That's what you'll find here."),
    block("Clear reporting."),
    block("Thoughtful analysis."),
    block("And stories that respect the intelligence of rugby supporters."),
    block("Our focus is the rugby we all care about."),
    block("Leinster. Munster. Ulster. Connacht. The URC. The Ireland national team. And the biggest stories from the international game."),
